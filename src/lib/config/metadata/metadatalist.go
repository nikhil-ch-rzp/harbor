...
var (
	...
	ConfigList = []Item{
		...
		{Name: common.PostGreSQLConnMaxLifetime, Scope: SystemScope, Group: DatabaseGroup, EnvKey: "POSTGRESQL_CONN_MAX_LIFETIME", DefaultValue: "15m", ItemType: &DurationType{}, Editable: false},
		...
		{Name: common.PostGreSQLQueryTimeout, Scope: SystemScope, Group: DatabaseGroup, EnvKey: "POSTGRESQL_QUERY_TIMEOUT", DefaultValue: "10m", ItemType: &DurationType{}, Editable: false},
